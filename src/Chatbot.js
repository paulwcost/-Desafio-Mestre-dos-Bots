...
const BiologyChatbot = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // URL para modelo Gemini-2.0-flash
            ...
            contents: [
              {
                ...
                parts: [
                  {
                    text: `Você é um assistente especializado em biologia. 
                           Responda à seguinte pergunta de forma detalhada, 
                           mas sem ser muito longa, utilizando termos científicos corretos: ${userInput}`
                  }
                ]
              }
            ],
